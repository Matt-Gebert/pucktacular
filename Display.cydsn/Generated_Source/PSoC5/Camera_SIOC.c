...
*
* \funcusage
*  \snippet Camera_SIOC_SUT.c usage_Camera_SIOC_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Camera_SIOC_SUT.c usage_Camera_SIOC_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Camera_SIOC_SUT.c usage_Camera_SIOC_Read  
*******************************************************************************/
...
* preferred Camera_SIOC_Read() API because the 
* Camera_SIOC_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Camera_SIOC_SUT.c usage_Camera_SIOC_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Camera_SIOC_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Camera_SIOC_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Camera_SIOC_0_INTR       (First pin in the list)
    *  - Camera_SIOC_1_INTR       (Second pin in the list)
    *  - ...
    *  - Camera_SIOC_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Camera_SIOC_SUT.c usage_Camera_SIOC_SetInterruptMode
    *******************************************************************************/
    void Camera_SIOC_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Camera_SIOC_0_INTR) != 0u) 
		{ 
			 Camera_SIOC_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Camera_SIOC_SUT.c usage_Camera_SIOC_ClearInterrupt
    *******************************************************************************/
