...
*
* \funcusage
*  \snippet Camera_VSYNC_SUT.c usage_Camera_VSYNC_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Camera_VSYNC_SUT.c usage_Camera_VSYNC_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Camera_VSYNC_SUT.c usage_Camera_VSYNC_Read  
*******************************************************************************/
...
* preferred Camera_VSYNC_Read() API because the 
* Camera_VSYNC_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Camera_VSYNC_SUT.c usage_Camera_VSYNC_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Camera_VSYNC_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Camera_VSYNC_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Camera_VSYNC_0_INTR       (First pin in the list)
    *  - Camera_VSYNC_1_INTR       (Second pin in the list)
    *  - ...
    *  - Camera_VSYNC_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Camera_VSYNC_SUT.c usage_Camera_VSYNC_SetInterruptMode
    *******************************************************************************/
    void Camera_VSYNC_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Camera_VSYNC_0_INTR) != 0u) 
		{ 
			 Camera_VSYNC_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Camera_VSYNC_SUT.c usage_Camera_VSYNC_ClearInterrupt
    *******************************************************************************/
