...
CY_ISR(Camera_I2C_ISR)
{
...
#ifdef Camera_I2C_ISR_ENTRY_CALLBACK
    Camera_I2C_ISR_EntryCallback();
#endif /* Camera_I2C_ISR_ENTRY_CALLBACK */
        ...
        if(Camera_I2C_CHECK_BYTE_COMPLETE(tmpCsr))
        {
            ...
            /* Check for software address detection */
                ...
                if(tmp8 == Camera_I2C_slAddress)   /* Check for address match */
                {
                    ...
                    #ifdef Camera_I2C_SW_PREPARE_READ_BUF_CALLBACK
                        Camera_I2C_SwPrepareReadBuf_Callback();
                    #endif /* Camera_I2C_SW_PREPARE_READ_BUF_CALLBACK */
                ...
                #ifdef Camera_I2C_SW_ADDR_COMPARE_ENTRY_CALLBACK
                    Camera_I2C_SwAddrCompare_EntryCallback();
                #endif /* Camera_I2C_SW_ADDR_COMPARE_ENTRY_CALLBACK */
                ...
                #ifdef Camera_I2C_SW_ADDR_COMPARE_EXIT_CALLBACK
                    Camera_I2C_SwAddrCompare_ExitCallback();
                #endif /* Camera_I2C_SW_ADDR_COMPARE_EXIT_CALLBACK */
                }
                ...
                #ifdef Camera_I2C_HW_PREPARE_READ_BUF_CALLBACK
                    Camera_I2C_HwPrepareReadBuf_Callback();
                #endif /* Camera_I2C_HW_PREPARE_READ_BUF_CALLBACK */
...
#ifdef Camera_I2C_ISR_EXIT_CALLBACK
    Camera_I2C_ISR_ExitCallback();
#endif /* Camera_I2C_ISR_EXIT_CALLBACK */    
}
    ...
    *******************************************************************************/
    ...
    {
    #ifdef Camera_I2C_WAKEUP_ISR_ENTRY_CALLBACK
        Camera_I2C_WAKEUP_ISR_EntryCallback();
    #endif /* Camera_I2C_WAKEUP_ISR_ENTRY_CALLBACK */
    ...
    #ifdef Camera_I2C_WAKEUP_ISR_EXIT_CALLBACK
        Camera_I2C_WAKEUP_ISR_ExitCallback();
    #endif /* Camera_I2C_WAKEUP_ISR_EXIT_CALLBACK */
    }
