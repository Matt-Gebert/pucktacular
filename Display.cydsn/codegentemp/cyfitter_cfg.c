...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000578u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x480005A0u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG3_CFG0), 0x15F8u);
