...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("1a7fa9ad-fff9-49d6-95d7-d25ad6076f17"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("dbc54e60-d06a-43ba-af51-e2f5f86c3d59"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("4f2643a4-2ebd-4c3d-b9d5-08431ac5eb51"),
		  .source_clock_id(""),
		  .divisor(0),
