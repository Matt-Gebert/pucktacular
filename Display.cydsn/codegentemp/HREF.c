...
*
* \funcusage
*  \snippet HREF_SUT.c usage_HREF_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet HREF_SUT.c usage_HREF_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet HREF_SUT.c usage_HREF_Read  
*******************************************************************************/
...
* preferred HREF_Read() API because the 
* HREF_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet HREF_SUT.c usage_HREF_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: HREF_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use HREF_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - HREF_0_INTR       (First pin in the list)
    *  - HREF_1_INTR       (Second pin in the list)
    *  - ...
    *  - HREF_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet HREF_SUT.c usage_HREF_SetInterruptMode
    *******************************************************************************/
    void HREF_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & HREF_0_INTR) != 0u) 
		{ 
			 HREF_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet HREF_SUT.c usage_HREF_ClearInterrupt
    *******************************************************************************/
