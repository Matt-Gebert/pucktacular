...
*
* \funcusage
*  \snippet Camera_SIOD_SUT.c usage_Camera_SIOD_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Camera_SIOD_SUT.c usage_Camera_SIOD_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Camera_SIOD_SUT.c usage_Camera_SIOD_Read  
*******************************************************************************/
...
* preferred Camera_SIOD_Read() API because the 
* Camera_SIOD_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Camera_SIOD_SUT.c usage_Camera_SIOD_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Camera_SIOD_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Camera_SIOD_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Camera_SIOD_0_INTR       (First pin in the list)
    *  - Camera_SIOD_1_INTR       (Second pin in the list)
    *  - ...
    *  - Camera_SIOD_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Camera_SIOD_SUT.c usage_Camera_SIOD_SetInterruptMode
    *******************************************************************************/
    void Camera_SIOD_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Camera_SIOD_0_INTR) != 0u) 
		{ 
			 Camera_SIOD_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Camera_SIOD_SUT.c usage_Camera_SIOD_ClearInterrupt
    *******************************************************************************/
