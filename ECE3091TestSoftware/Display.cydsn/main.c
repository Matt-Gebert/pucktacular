...
int main()
{
    ...
    for(;;n++)
    {
        /*Note, for the PWM modulation
            -A cycle is 20ms.
            -This has 255 steps.
            -13 steps corresponds to 2.5ms. {Left}
            -19 steps corresponds to 1.5ms. {Middle}
            -25 steps corresponds to 2ms. {Right}
               
            Our full extension is all the way to the left, 
            and then only about 1/3 of the way to the centre.
        */
        PWM_2_WriteCompare(13);
        CyDelay(1000);
        PWM_2_WriteCompare(15);
        CyDelay(1000);
    }
}
//*************************************************
